    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Box office coming", "WakandaForEver" },
                    { 2, 2, "Box office coming two", "WakandaForEver2" },
                    { 3, 3, "Box office coming three", "WakandaForEver3" },
                    { 4, 2, "Box office coming two", "WakandaForEver2bis" }
                });
